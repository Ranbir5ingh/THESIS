...
function ExploreFallback(){
  return (
    <div className="space-y-8" aria-busy="true" aria-label="Loading explore">
      <div className="max-w-3xl">
        <p className="section-kicker">Explore the market</p>
        <h1 className="mt-3 text-4xl font-black tracking-tight sm:text-6xl">Start with a <span className="text-[var(--accent)]">question.</span></h1>
        <p className="mt-4 text-[var(--muted)] sm:text-lg">Search a company or ticker. THESIS will show the business, the risk, the hype and how it fits your decision — not just a price.</p>
      </div>
      <div className="max-w-4xl rounded-2xl border border-[var(--line-strong)] bg-[#0a0c10]/80 px-4 py-5 text-sm text-[var(--muted)] shadow-2xl backdrop-blur-2xl">Loading market search…</div>
    </div>
  );
}
